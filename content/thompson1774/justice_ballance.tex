\danceNameS{Ju{\longs}tice Ballance}{Justice Ballance}{longDMin}{thompson1774}%danceName must be followed by blank line for proper command parsing
...
% forcing line break
% \sk for horizontal space of 1 noteskip
%%%%%%%% PART A %%%%%%%%
    \notes\cu{d}\en\xbar%
    \notes\Qqbl2345\Qqbl6786\en\xbar%
    \notes\ql9\Dqbl87\ql6\ql6\en\xbar%
    \notes\Qqbl7543\Qqbl6432\en\xbar%
    \notes\Qqbu5342\tinynotesize\cu2\normalnotesize\qu1\Dqbu{e}{d}\en\alaligne%
    %
    \notes\Qqbl2345\Qqbl6786\en\xbar%
    \notes\ql9\Dqbl87\ql{10}\ql9\en\xbar%
    \notes\Qqbl8{10}86\Ibl0753\qb07\qb09\qb07\sh5\tbl0\qb05\en\xbar%
    \notes\ql6\qu{d}\qup{d}\en\leftrightrepeat%
%%%%%%%% PART B %%%%%%%%
    \notes\cu3\en\alaligne%
    %
    \notes\Qqbl6789\ql{10}\ql5\en\xbar%
    \notes\ql5\Dqbu43\ql4\ql6\en\xbar%
    \notes\Qqbl7543\Qqbl6432\en\xbar%
    \notes\Qqbu5342\Qqbu310d\en\alaligne%
    %
    \notes\Qqbl2345\Qqbl6786\en\xbar%
    \notes\ql9\Dqbl87\ql6\ql5\en\xbar%
    \notes\Qqbl4642\Qqbl3531\en\xbar%
    \notes\qu2\qu{N}\qup{N}\en\leftrightrepeat%
    \endpiece%
\end{music}
1$.^{st}$ Cu. lead thro' the 2$.^d$ Cu. \& ca{\longs}t up \Thaaa
2$.^d$ Cu. lead thro' the 1$.^{st}$ Cu. \& ca{\longs}t off \Thbaa
cro{\longs}s over \& turn \Thaab
Right \& Left \Thbab
\HRule
\HRule
\vspace{1em}

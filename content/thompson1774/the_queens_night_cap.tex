\danceNameS{The Queen's Night-Cap}{Queen's Night-Cap, The}{longTMin}{thompson1774}%danceName must be followed by blank line for proper command parsing
...
%%%%%%%% PART A %%%%%%%%
    \notes\Ibl0883\qbp08\tbbl0\qb08\qbp08\tbbl0\tbl0\qb08\en\xbar%
    \notes\tr9\qlp8\cl6\en\xbar%
    \notes\Qqbu5321\en\xbar%
    \notes\qu2\Dqbu34\en\alaligne%
    %
    \notes\Qqbl5888\en\xbar%
    \notes\ql8\Dqbl76\en\xbar%
    \notes\Dqbl79\na4\Dqbl46\en\xbar%
    \notes\hl5\en\leftrightrepeat\alaligne%
%%%%%%%% PART B %%%%%%%%
    \notes\Qqbl9999\en\xbar%
    \notes\tr{11}\ql9\ql{10}\en\xbar%
    \notes\Qqbl9876\en\xbar%
    \notes\Qqbu5432\en\alaligne%
    %
    \notes\Qqbu3153\en\xbar%
    \notes\ql8\Dqbl76\en\xbar%
    \notes\Qqbu5432\en\xbar%
    \notes\hu1\en\rightrepeat%
    \endpiece%
\end{music}

Hands all four a cro{\longs}s \Thaaa
and back again \Thbaa
Cro{\longs}s over one Cu: lead thro the 3$\_^d$ Cu: \Thaab
right Hands and left \Thbab
\HRule
\HRule
\vspace{1em}

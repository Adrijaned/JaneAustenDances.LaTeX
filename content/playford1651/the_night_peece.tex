\danceNameS{The Night Peece}{Night Peece, The}{set6}%danceName must be followed by blank line for proper command parsing
...
\begin{multicols}{2}
    Leade up a D. forwards and back \Pfa That againe \Pfb
    \columnbreak

    The middle Cu. fall back and {\s}lip up, while the fir{\s}t and la{\s}t Cu. change places. That againe. That againe \Pfa
\end{multicols}
\HRule
\begin{multicols}{2}
    ...
    Fir{\s}t Cu. cro{\s\s}e over, fall into the 2. place, cro{\s\s}e againe, fall into the la{\s}t, the next Cu. as much, the next Cu. as much \Pfa
\end{multicols}
\HRule
\begin{multicols}{2}
    Armes all \Pfa That again \Pfb
    \columnbreak

    Fir{\s}t man change places with the 2. Wo. fir{\s}t Wo. change with the 2. man, while the la{\s}t changes with his owne:
    Then change with the la{\s}t Wo. your Wo. change with the la{\s}t man, while the other changes with his owne: Set all and turne {\s}ingle \Pfa
\end{multicols}

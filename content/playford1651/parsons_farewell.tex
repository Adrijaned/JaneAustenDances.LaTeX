\danceNameS{Par{\s}ons farewell}{Parsons farewell}{set4}%danceName must be followed by blank line for proper command parsing

{\large For foure\footnote{pánové s dámou po pravém boku, páry naproti sobě}\hfill \Source{Playford1651}}  % TODO music
...
\begin{multicols}{2}
    Meet all, foure {\s}lips to the left hand \Pfa Back all, foure {\s}lips to the right hand \Pfb
    \columnbreak

    Men ri{\s}e once, We. ri{\s}e once, ri{\s}e all foure times, turne each others Wo. \Pfa
    We. ri{\s}e once, men once, re{\s}e all foure times, turne each others woman \Pfb
\end{multicols}
\HRule
\begin{multicols}{2}
    Meet all, leade each others Wo. a D. to the left hand \Pfa
    Change hands, meet againe, take your owne We. and to your places \Pfb
    \columnbreak

    Men meet, cro\s{\s}e right hands, then left pa{\s}{\s}e over, turne each others Wo. with your right hand,
    cro{\s}{\s}e to your place againe, and turne your owne \Pfa We. as much with the Co. hands \Pfb
\end{multicols}
\HRule
\begin{multicols}{2}
    Take your owne by both hands, and meet with four {\s}lips, take the Co. We. foure {\s}lips to the left hand \Pfa
    Meet againe, take your owne and to your places \Pfb
    \columnbreak

    Turne your own with your right hands, men cro{\s}{\s}e, and go all the S. Hey to the Co. {\s}ide and turne your owne \Pfa
    Turne your owne with the left hands, We. cro{\s}{\s}e, go the {\s}ingle Hey to your places, and turne your owne \Pfb
\end{multicols}
